...
class DevelopmentConfig(Config):
    ...
    # 也可如下来写，比较清晰
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://{username}:{password}@{mysql_address}/{databasename}" \
        .format(username='username', password='password', mysql_address='mysql_address', databasename="test")
